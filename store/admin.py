...
from .models import (
    ...
    StockNotification, Wishlist, PriceDropNotification, Address, CancellationRequest, ReturnRequest, Review,Category,ProductImage
)
from django.contrib.sessions.models import Session

from .views import initiate_razorpay_refund, send_cancellation_email
...
class OrderAdmin(admin.ModelAdmin):
    list_display = ['id', 'user', 'total_amount', 'payment_mode', 'payment_status', 'status', 'created_at']
...
class ReturnRequestAdmin(admin.ModelAdmin):
    list_display = ['id', 'order', 'reason', 'status', 'requested_at']
    list_filter = ['status']
